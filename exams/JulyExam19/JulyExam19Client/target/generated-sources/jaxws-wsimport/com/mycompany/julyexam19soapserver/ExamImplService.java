 ...
 * 
 */
@WebServiceClient(name = "ExamImplService", targetNamespace = "http://julyexam19soapserver.mycompany.com/", wsdlLocation = "http://localhost:9000/MovieService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EXAMIMPLSERVICE_QNAME = new QName("http://julyexam19soapserver.mycompany.com/", "ExamImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9000/MovieService?wsdl");
    ...
    public ExamInterface getExamImplPort() {
        return super.getPort(new QName("http://julyexam19soapserver.mycompany.com/", "ExamImplPort"), ExamInterface.class);
    }
     ...
     */
    @WebEndpoint(name = "ExamImplPort")
    public ExamInterface getExamImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://julyexam19soapserver.mycompany.com/", "ExamImplPort"), ExamInterface.class, features);
    }
